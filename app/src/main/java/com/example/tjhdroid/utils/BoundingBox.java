...
import static com.example.tjhdroid.utils.MyMath.gudermann;
import static com.example.tjhdroid.utils.MyMath.gudermannInverse;
...
public class BoundingBox implements Parcelable, Serializable {
    ...
    public static double getCenterLongitude(final double pWest, final double pEast) {
        ...
        return com.example.tjhdroid.views.MapView.getTileSystem().cleanLongitude(longitude);
    }
