package com.example.tjhdroid.config;


import android.content.Context;
import android.content.SharedPreferences;

import com.example.tjhdroid.tileprovider.MapTileCache;
...
public interface IConfigurationProvider {
     ...
     * from {@link com.example.tjhdroid.tileprovider.constants.OpenStreetMapTileProviderConstants}
     *
     * @return
     */
    boolean isDebugMode();
     ...
     * @see com.example.tjhdroid.views.overlay.Polygon
     * @see com.example.tjhdroid.views.overlay.Polyline
     */
     ...
     * Sets the location where the tile cache is stored. Changes are only in effect when the {@link {@link com.example.tjhdroid.views.MapView}}
     * is created. Changes made after it's creation (either pogrammatic or via layout inflator) have
     * no effect until the map is restarted or the {@link com.example.tjhdroid.views.MapView#setTileProvider(MapTileProviderBase)}
     ...
     * by default, maps to getOsmdroidBasePath() + "/tiles"
     * By default, it is defined in SD card, osmdroid directory.
     * Sets the location where the tile cache is stored. Changes are only in effect when the {@link com.example.tjhdroid.views.MapView}}
     * is created. Changes made after it's creation (either pogrammatic or via layout inflator) have
     * no effect until the map is restarted or the {@link com.example.tjhdroid.views.MapView#setTileProvider(MapTileProviderBase)}
     * is changed or recreated.
     * <p>
     ...
     * server specified expiration time stamp or the default expiration time {{@link com.example.tjhdroid.tileprovider.constants.OpenStreetMapTileProviderConstants#DEFAULT_MAXIMUM_CACHED_FILE_AGE}}
     * <p>
     ...
     *
     * @param value
     * @see com.example.tjhdroid.views.overlay.TilesOverlay
     * @since 6.0.0
     */
