...
import com.example.tjhdroid.tileprovider.BitmapPool;
import com.example.tjhdroid.utils.BoundingBox;
import com.example.tjhdroid.utils.GeoPoint;
import com.example.tjhdroid.utils.RectL;
import com.example.tjhdroid.views.MapView;
import com.example.tjhdroid.views.MapViewRepository;
import com.example.tjhdroid.views.Projection;
import com.example.tjhdroid.views.overlay.infowindow.MarkerInfoWindow;

/**
 * A marker is an icon placed at a particular point on the map's surface that can have a popup-{@link com.example.tjhdroid.views.overlay.infowindow.InfoWindow} (a bubble)
