package com.example.tjhdroid.views.overlay.infowindow;
...
import com.example.tjhdroid.views.overlay.Marker;

/**
 * {@link com.example.tjhdroid.views.overlay.infowindow.MarkerInfoWindow} is the default
 * implementation of {@link com.example.tjhdroid.views.overlay.infowindow.InfoWindow} for a
 * {@link com.example.tjhdroid.views.overlay.Marker}.
 * <p>
 * It handles
 * <p>
 * R.id.bubble_title          = {@link com.example.tjhdroid.views.overlay.OverlayWithIW#getTitle()},
 * R.id.bubble_subdescription = {@link com.example.tjhdroid.views.overlay.OverlayWithIW#getSubDescription()},
 * R.id.bubble_description    = {@link com.example.tjhdroid.views.overlay.OverlayWithIW#getSnippet()},
 * R.id.bubble_image          = {@link com.example.tjhdroid.views.overlay.Marker#getImage()}
 * <p>
