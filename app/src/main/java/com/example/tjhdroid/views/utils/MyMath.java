 ...
 * @deprecated Use {@link com.example.tjhdroid.utils.MyMath} instead
 */
@Deprecated
public class MyMath {
    // ===========================================================
     ...
     * @param factor
     * @return
     * @deprecated Use {@link com.example.tjhdroid.utils.MyMath#getNextSquareNumberAbove(float)} instead
     */
    @Deprecated
    public static int getNextSquareNumberAbove(final float factor) {
        return com.example.tjhdroid.utils.MyMath.getNextSquareNumberAbove(factor);
    }
