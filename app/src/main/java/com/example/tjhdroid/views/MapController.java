...
import com.example.tjhdroid.views.MapView.OnFirstLayoutListener;
    ...
    private static class MapAnimatorListener
        ...
        public MapAnimatorListener(final MapController pMapController,
            ...
            if (pOrientationEnd == null) {
                ...
                mOrientationSpan = (float) com.example.tjhdroid.utils.MyMath.getAngleDifference(mOrientationStart, pOrientationEnd, pClockwise);
            }
        }
