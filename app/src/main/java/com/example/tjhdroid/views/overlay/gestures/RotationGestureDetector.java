package com.example.tjhdroid.views.overlay.gestures;
 ...
 * to listen for rotation changes on the {@link com.example.tjhdroid.views.MapView} then use {@link org.osmdroid.views.MapView#setMapListener(MapListener)}
